...
class DepthImageSaver(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(Image,'/zed/zed_node/depth/depth_registered',self.image_callback,10)
        self.save_directory = '/home/data/unsynchronized_dataset/datasets/ORFD/testing/sequence/dense_depth'
